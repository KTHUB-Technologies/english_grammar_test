...
class AppColors {
  static final primary = Color(0xFF191d3b);
  static final secondary = Color(0xFF8B94BC);
  ...
  static const List<Color> gradientColorPrimary  = [Color(0xFF1488CC),Color(0xFF2B32B2)];
